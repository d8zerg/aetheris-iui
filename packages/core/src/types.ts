// ---- Domain enumerations (mirror of C++ domain enums) ----
...
export type ServerMessage =
  | { readonly type: 'session_created'; readonly session: Session }
  | { readonly type: 'session_updated'; readonly session: Session }
  | {
      readonly type: 'error';
...
export type ClientMessage =
  ...
  | { readonly type: 'preview'; readonly session_id: string }
  | { readonly type: 'confirm'; readonly session_id: string }
  | { readonly type: 'reject_preview'; readonly session_id: string }
  | {
